...
const Contact = () => {
    ...
    emailjs
      .send(
        ...
        "template_7yyc7ek",
        {
          from_name: form.name,
          to_name: "Pratham",
          // to_email: 'prathamshah1006@gmail.com',
          message: form.message + " (Sender's email id is: " + form.email+")",
          reply_to: form.email,
        },
        "e4nk8gUcS60iAHJoN"
      )
  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div variants={slideIn('left', 'tween', 0.2, 1)} className="flex-[0.5] bg-black-100 p-8 rounded-2xl">
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          ...
          <label className="flex flex-col">
            ...
            <textarea name="message" value={form.message} onChange={handleChange} placeholder="What's do you want to say?" className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium"/>
          </label>
